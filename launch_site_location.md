...
# If class=1 → green, if class=0 → red
...
city_marker = folium.Marker(
    ...
    icon=DivIcon(
        icon_size=(20, 20),
        icon_anchor=(0, 0),
        html='<div style="font-size: 12; color:#0000ff;"><b>City: %s KM</b></div>'
             % "{:.2f}".format(distance_city),
    )
)
...
# --- Highway (US-1 near Kennedy Space Center) ---
highway_lat = 28.56230
highway_lon = -80.70440
...
highway_marker = folium.Marker(
    ...
    icon=DivIcon(
        icon_size=(20, 20),
        icon_anchor=(0, 0),
        html='<div style="font-size: 12; color:#228B22;"><b>Hwy: %s KM</b></div>'
             % "{:.2f}".format(distance_highway),
    )
)
